import { urlParams, validatePathParam } from "../../../../../../@scaleway_sdk-client@2.6.0/node_modules/@scaleway/sdk-client/dist/helpers/marshalling.mjs";
import { waitForResource } from "../../../../../../@scaleway_sdk-client@2.6.0/node_modules/@scaleway/sdk-client/dist/internal/async/interval-retrier.mjs";
import { API as API$1 } from "../../../../../../@scaleway_sdk-client@2.6.0/node_modules/@scaleway/sdk-client/dist/scw/api.mjs";
import { enrichForPagination } from "../../../../../../@scaleway_sdk-client@2.6.0/node_modules/@scaleway/sdk-client/dist/scw/fetch/resource-paginator.mjs";
import { toApiLocality } from "../../../../../../@scaleway_sdk-client@2.6.0/node_modules/@scaleway/sdk-client/dist/scw/locality.mjs";
import "../../../../../../@scaleway_sdk-client@2.6.0/node_modules/@scaleway/sdk-client/dist/index.mjs";
import { CONTAINER_TRANSIENT_STATUSES, DOMAIN_TRANSIENT_STATUSES, NAMESPACE_TRANSIENT_STATUSES, TRIGGER_TRANSIENT_STATUSES } from "./content.gen.mjs";
import { marshalCreateContainerRequest, marshalCreateDomainRequest, marshalCreateNamespaceRequest, marshalCreateTriggerRequest, marshalUpdateContainerRequest, marshalUpdateDomainRequest, marshalUpdateNamespaceRequest, marshalUpdateTriggerRequest, unmarshalContainer, unmarshalDomain, unmarshalListContainersResponse, unmarshalListDomainsResponse, unmarshalListNamespacesResponse, unmarshalListTriggersResponse, unmarshalNamespace, unmarshalTrigger } from "./marshalling.gen.mjs";

//#region node_modules/.pnpm/@scaleway+sdk-container@2.12.0_@scaleway+sdk-client@2.6.0/node_modules/@scaleway/sdk-container/dist/v1/api.gen.js
...
var API = class extends API$1 {
	constructor(..._args) {
		...
		this.pageOfListTriggers = (request = {}) => this.client.fetch({
			method: "GET",
			path: `/containers/v1/regions/${validatePathParam("region", request.region ?? this.client.settings.defaultRegion)}/triggers`,
			urlParams: urlParams(["container_id", request.containerId], ["namespace_id", request.namespaceId], ["order_by", request.orderBy], ["organization_id", request.organizationId], ["page", request.page], ["page_size", request.pageSize ?? this.client.settings.defaultPageSize], ["project_id", request.projectId], ["trigger_type", request.triggerType])
