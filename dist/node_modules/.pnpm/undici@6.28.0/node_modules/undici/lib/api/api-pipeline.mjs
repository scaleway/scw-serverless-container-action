...
import { require_abort_signal } from "./abort-signal.mjs";
...
var require_api_pipeline = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	const { Readable, Duplex, PassThrough } = __require("node:stream");
...
//#endregion
export default require_api_pipeline();

export { require_api_pipeline };