...
import { require_readable } from "./readable.mjs";
import { require_util as require_util$1 } from "./util.mjs";
...
var require_api_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const { getResolveErrorBodyCallback } = require_util$1();
...
//#endregion
export default require_api_request();

export { require_api_request };