...
import { require_dispatcher_base } from "./dispatcher-base.mjs";
import { require_connect } from "../core/connect.mjs";
import { require_client } from "./client.mjs";
import { require_pool } from "./pool.mjs";
import { require_agent } from "./agent.mjs";
...
var require_proxy_agent = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	const { kProxy, kClose, kDestroy, kDispatch, kInterceptors } = require_symbols();
...
//#endregion
export default require_proxy_agent();

export { require_proxy_agent };